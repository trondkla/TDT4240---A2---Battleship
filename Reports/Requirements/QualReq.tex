...
Modifiability in an architectural sense is concerned about the cost of changeÂ \cite{pensum}. Our main approach is mainly concerned with changes made in \emph{design time}\footnote{Design time is conserned with measures and initiatives that is being implemented as the application is being designed. Even though everything leading up the moment of delivery is in a broad sense design time, most of the initiatives should be implemented in the design phase of the project. This is opposed to \emph{run time}, which is conserned with what occurs after the application has been deployed and is being used by an actual end user.}.
...
% TODO: KILDE!
    ...
    \begin{itemize}
        ...
        \begin{tabular}{| l | p{7cm} |}
            ...
            \hline
            Source &  Developer \\
            Stimulus & Add difficulty levels \\
...
\newpage        
        ...
        \textit{\small{The user shall be able to change the color of their player color, i.e. the colors of their ships and other UI elements.}}
        ...
        \textit{\small{The user shall be able to set their player name before they start the game.}}
...
%        \item[\textbf{U1}] Communicating legal actions \\
        ...
        \begin{tabular}{| l | p{7cm} |}
            ...
            Response & The player name will appear at the game play screen, and the ships will be painted in the predefined player color. The name and color will also be saved for later gameplays. \\
        ...
        \textit{\small{The user shall be promted to confirm their actions for severe decisions.}}
        ...
        \begin{tabular}{| l | p{7cm} |}
            ...
            Response & Dialog box with confirmation button(s) (e.g. "OK") \\
        ...
        \item[\textbf{U5}] The game shall show game hints whereever appropriate. \\
        ...
        \begin{tabular}{| l | p{7cm} |}
            ...
            \hline
            Source & End User \\
            Stimulus & User is uncertain on how the game is played, or what their next move can be \\
            Artifact & System \\
            Environment & Run-time \\
